...
#ifndef OBOE_MP3_OBOE_ENGINE_H
#define OBOE_MP3_OBOE_ENGINE_H
...
class Mp3OboeEngine : public IRestartable {

public:
    Mp3OboeEngine();

    virtual ~Mp3OboeEngine() = default;
    ...
    oboe::Result start(const char *mp3file, oboe::AudioApi audioApi, int deviceId, int channelCount);
...
private:
    ...
    std::shared_ptr<Mp3Generator> mAudioSource;
